<template>
  <div class="wrapper">
    <div class="card-form">
      ...
      <!-- <div>
        <h1 data-ref="cardNumber" @click="focusInput">fewfwefweffewf</h1>
      </div> -->
      <div
        class="card-form__inner"
        @click.capture="flipCard(false)"
        v-if="order_info"
      >
        <v-divider></v-divider>
        <v-row no-gutters>
        ...
        <!-- <v-row no-gutters align="center" justify="center"
          ><h3 class="pa-1">Комментарий</h3></v-row
        > -->
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    dialogOpenEditById() {
      ...
      this.otherCardMask = this.generateCardNumberMask;
