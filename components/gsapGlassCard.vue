      ...
      <defs>
        ...
        >
          <image
            ...
            width="100"
            height="100"
            xlink:href="https://assets.codepen.io/721952/whiteNoise2.png"
          />
          <image
            class="fillLight"
            opacity="0.5"
            width="100"
            height="100"
            xlink:href="https://assets.codepen.io/721952/whiteNoise.png"
          />
        </pattern>
      ...
      <g class="main" id="main">
        ...
        <g class="card">
          ...
          <rect
            ...
            opacity="0.8"
          />
          <text class="numTxt" fill="#f0f0f0" font-size="23">
            4678 9743 6489 9721
          </text>
          <text class="nameTxt" fill="#e4e4f4" font-size="15">CARD PORTAL</text>
          <g class="chip">
...
export default {
  ...
  mounted() {
    const { to, set, add, timeline, registerPlugin } = this.gsap;
    let time = timeline({
      paused: false,
    })
