  ...
  <card>
    <ValidationObserver v-slot="{ handleSubmit }">
      <form @submit.prevent="handleSubmit(update)">
        ...
        ></v-textarea>
        <div class="container b-color margin-b">
        ...
        <div class="container b-color margin-b">
            ...
            <!-- <div v-if="form.license"> -->
                <v-row></v-row>
                <v-row v-for="(item, i) in form.license" :key="i">
                    <!-- {{year}} {{description}} -->
                    <v-col cols="3">
                        <v-text-field
                            v-model="item.year"
                    ...
                    <v-col cols="9">
                        <v-text-field
                            ...
                            @click:append-outer="deleteLicense(i)"
                            solo
                            dark
                            hide-details
                            background-color="#131528"
                ...
                <v-layout justify-center>
                    <v-card-actions>
                        <v-btn icon large color="red" @click="new_license()">
                            <img width="34" :src="'/icons/MarineIcons/uil_job openings.svg'" alt="">
                        </v-btn>
                    </v-card-actions>
                </v-layout>
            <!-- </div> -->
...
export default { 
  ...
  return bObject;
      ...
      let a  = { ...this.form , ...this.user.EmployerData}
      this.form = copy({ ...this.form , ...this.user.EmployerData})
  ...
  methods: {
    ...
    new_license(){
        ...
        this.form.license.push({"year":null, "description":null})
        console.log(this.form.license)
    },
    deleteLicense(i){
        this.form.license.splice(i, 1) 
    }
  },
};
</script>
